...
import accessory from '../assets/headphones/headphones (1).jpg'
import phon from '../assets/headphones/headphones (2).jpg'
import watc from '../assets/headphones/headphones (4).jpg'
import headphon from '../assets/headphones/headphones (10).jpg'
import smartwatch from '../assets/headphones/headphones (3).jpg'
import speaker from '../assets/headphones/headphones (7).jpg'
...
const Headphones = () => {
  return (
    ...
    >
      <div className='mt-15'>
                <h1 className='text-3xl text-center pt-5 font-bold text-blue-600'>HeadPhones</h1>
